...
class DataType_Babel extends DataTypePlugin {
	protected $isEnabled = true;
	protected $dataTypeName = "Babel Custom List";
	protected $dataTypeFieldGroup = "other";
	protected $dataTypeFieldGroupOrder = 50;
	protected $jsModules = array("Babel.js");
	...
	<select name="dtExample_%ROW%" id="dtExample_%ROW%">
		...
		<option value="{$this->L["indicator_values"]}">{$this->L["indicator_label"]}</option>
	</select>
	<div>
